...
_sage_const_1 = Integer(1); _sage_const_2 = Integer(2); _sage_const_8 = Integer(8); _sage_const_0xFF = Integer(0xFF); _sage_const_0 = Integer(0); _sage_const_255 = Integer(255); _sage_const_4 = Integer(4); _sage_const_19 = Integer(19); _sage_const_121665 = Integer(121665); _sage_const_121666 = Integer(121666); _sage_const_32 = Integer(32); _sage_const_15112221349535400772501151409588531511454012693041857206046113283949847762202 = Integer(15112221349535400772501151409588531511454012693041857206046113283949847762202); _sage_const_46316835694926478169428394003475163141307993866256225615783033603165251855960 = Integer(46316835694926478169428394003475163141307993866256225615783033603165251855960); _sage_const_5 = Integer(5); _sage_const_448 = Integer(448); _sage_const_224 = Integer(224); _sage_const_39082 = Integer(39082); _sage_const_39081 = Integer(39081); _sage_const_56 = Integer(56); _sage_const_345397493039729516374008604150537410266655260075183290216406970281645695073672344430481787759340633221708391583424041788924124567700732 = Integer(345397493039729516374008604150537410266655260075183290216406970281645695073672344430481787759340633221708391583424041788924124567700732); _sage_const_363419362147803445274661903944002267176820680343659030140745099590306164083365386343198191849338272965044442230921818680526749009182718 = Integer(363419362147803445274661903944002267176820680343659030140745099590306164083365386343198191849338272965044442230921818680526749009182718); _sage_const_224580040295924300187604334099896036246789641632564134246125461686950415467406032909029192869357953282578032075146446173674602635247710 = Integer(224580040295924300187604334099896036246789641632564134246125461686950415467406032909029192869357953282578032075146446173674602635247710); _sage_const_298819210078481492676017930443930673437544040154080242095928241372331506189835876003536878655418784733982303233503462500531545062832660 = Integer(298819210078481492676017930443930673437544040154080242095928241372331506189835876003536878655418784733982303233503462500531545062832660); _sage_const_1000 = Integer(1000); _sage_const_100 = Integer(100)
import binascii
...
class RistrettoPoint(QuotientEdwardsPoint):
    ...
    def doubleAndEncode(self):
        ...
        if self.cofactor==_sage_const_8 :
            e = _sage_const_2 *X*Y
            f = Z**_sage_const_2 +d*T**_sage_const_2 
            g = Y**_sage_const_2 -a*X**_sage_const_2 
            h = Z**_sage_const_2 -d*T**_sage_const_2 
            
            inv1 = _sage_const_1 /(e*f*g*h)
            z_inv = inv1*e*g # 1 / (f*h)
            t_inv = inv1*f*h
        
            if negative(e*g*z_inv):
                if a==-_sage_const_1 : sqrta = self.i
                else:     sqrta = -_sage_const_1 
            ...
            foo = Y**_sage_const_2 +a*X**_sage_const_2 
            bar = X*Y
            den = _sage_const_1 /(foo*bar)
            if negative(_sage_const_2 *bar**_sage_const_2 *den): tmp = a*X**_sage_const_2 
            else: tmp = Y**_sage_const_2 
            s = self.magic*(Z**_sage_const_2 -tmp)*foo*den
...
class Decaf_1_1_Point(QuotientEdwardsPoint):
    ...
    def doubleAndEncode(self):
        ...
        if self.cofactor == _sage_const_8 :
            ...
            e = _sage_const_2 *X*Y
            f = Y**_sage_const_2 +a*X**_sage_const_2 
            g = Y**_sage_const_2 -a*X**_sage_const_2 
            h = Z**_sage_const_2 -d*T**_sage_const_2 
            
            eim = e*self.isoMagic
            inv = _sage_const_1 /(eim*g*f*h)
            ...
            xy = X*Y
            h = Z**_sage_const_2 -d*T**_sage_const_2 
            inv = _sage_const_1 /(xy*h)
            if negative(inv*_sage_const_2 *xy**_sage_const_2 *self.isoMagic): tmp = Y
            else: tmp = X
            s = tmp**_sage_const_2 *h*inv # = X/Y or Y/X, interestingly
...
testDoubleAndEncode(Ed25519Point,_sage_const_100 )
testDoubleAndEncode(NegEd25519Point,_sage_const_100 )
testDoubleAndEncode(IsoEd25519Point,_sage_const_100 )
testDoubleAndEncode(IsoEd448Point,_sage_const_100 )
testDoubleAndEncode(TwistedEd448GoldilocksPoint,_sage_const_100 )
